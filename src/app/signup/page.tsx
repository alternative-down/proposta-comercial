    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-white to-orange-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Cadastrar na Proposta Comercial</h1>
          <p className="text-slate-500 mt-1">Crie sua conta e faça sua primeira proposta</p>
        </div>
